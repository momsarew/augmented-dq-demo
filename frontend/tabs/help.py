...
def render_help_tab(full=True):
    ...
    dims_help = [
        {"code": "DB", "nom": "Structure", "icon": ":material/database:", "question": "Le format/type est-il correct ?" if full else "Format/type correct ?", "exemple": "VARCHAR au lieu de NUMBER", "color": "#667eea"},
        {"code": "DP", "nom": "Traitements", "icon": ":material/sync_alt:", "question": "Les ETL ont-ils dégradé la donnée ?" if full else "ETL ont dégradé ?", "exemple": "Troncature, encodage cassé", "color": "#764ba2"},
        {"code": "BR", "nom": "Règles métier", "icon": ":material/gavel:", "question": "La valeur respecte-t-elle les règles ?" if full else "Respecte les règles ?", "exemple": "Salaire négatif, date future", "color": "#f093fb"},
        {"code": "UP", "nom": "Utilisabilité", "icon": ":material/visibility:", "question": "La donnée est-elle exploitable ?" if full else "Exploitable ?", "exemple": "Trop de valeurs manquantes", "color": "#38ef7d"},
    ]
    ...
    if full:
        # Weight explanation
        st.subheader("Pourquoi les pondérations changent tout")
        st.markdown("""
        ...
        onglets_help = [
            {"nom": "Scan", "desc": "Détecter les anomalies automatiquement", "quand": "Premier diagnostic"},
            {"nom": "Dashboard", "desc": "Vue globale, heatmap des risques", "quand": "Présentation COMEX"},
            {"nom": "Vecteurs", "desc": "Détail des 4 dimensions par attribut", "quand": "Diagnostic technique"},
            {"nom": "Priorités", "desc": "Top 5 des urgences à traiter", "quand": "Plan d'action"},
            {"nom": "Élicitation", "desc": "Ajuster les pondérations par usage", "quand": "Personnalisation métier"},
            {"nom": "Lineage", "desc": "Impact des transformations ETL", "quand": "Debug pipeline"},
            {"nom": "DAMA", "desc": "Comparaison avec approche classique", "quand": "Justification méthode"},
            {"nom": "Reporting", "desc": "Rapport personnalisé par profil", "quand": "Communication"},
        ]
            ...
            for j, col in enumerate(cols):
                if i + j < len(onglets_help):
                    ...
                    with col:
                        ...
                        ">
                            <div style="font-size: 1.25rem;"><strong>{o['nom']}</strong></div>
